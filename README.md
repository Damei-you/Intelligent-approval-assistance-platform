...
风险审查汇总还提供合同整改闭环：智能体把多项风险建议整合为可编辑的合同修订草案，
用户逐项确认后才创建同一合同的新修订版本。旧版本及其风险报告保持不变，新版本完成
异步向量化后可再次运行四项风险审查；新文档和修改条款均保存来源审查、风险项和来源
条款信息，确认请求使用幂等键并校验当前版本，避免重复点击或并发更新创建错误版本。
