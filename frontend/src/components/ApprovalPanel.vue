...
.approval-hero { padding: 30px 4px 34px; }.approval-eyebrow { display: flex; align-items: center; gap: 7px; color: var(--green); font-size: 10px; font-weight: 700; letter-spacing: .09em; }.approval-hero-row { margin-top: 13px; display: flex; align-items: flex-end; justify-content: space-between; gap: 30px; }.approval-hero h1 { margin: 0; color: var(--navy); font-family: Georgia, 'Noto Serif SC', serif; font-size: 20px; line-height: 1.08; letter-spacing: -.032em; }.approval-hero h1 em { color: var(--green); font-style: normal; }.approval-hero p { margin: 17px 0 0; color: #68756e; font-size: 12px; }.role-summary { padding: 15px 18px; display: flex; align-items: center; gap: 14px; border: 1px solid #cbd8cf; border-radius: 14px; background: rgba(255,255,255,.58); color: #819087; }.role-summary span { display: flex; align-items: center; gap: 8px; color: var(--green); }.role-summary b { color: var(--navy); font-size: 10px; }
...
@media (max-width: 680px) { .approval-page { width: min(100% - 24px, 1360px); }.approval-hero { padding-top: 38px; }.approval-hero h1 { font-size: 26px; }.role-summary { width: 100%; justify-content: center; }.approval-select-card, .approval-main, .action-panel { padding: 20px 17px; }.approval-select-row, .step-timeline, .approval-findings { grid-template-columns: 1fr; }.approval-heading { align-items: flex-start; flex-direction: column; } }
</style>
